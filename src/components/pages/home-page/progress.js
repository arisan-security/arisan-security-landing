...
export default function Progress() {
    return (
        <section className="px-4 md:px-[15%] py-16 md:py-24 flex items-start content-center bg-rich-black snap-start relative">
            <div className="grid grid-cols-1 md:grid-cols-2 md:gap-4 md:px-24 text-center md:text-left mx-auto">
